import { fileLineExtrSync, fileLineExtr, readFileLineSync } from "./readFileLine.ts"
import { getLineMarkers } from "./handleArg.ts";

export function lineCopyProtocolSync(file1: string, marker1: string, file2: string, marker2: string) {
